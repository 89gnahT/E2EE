...
struct Signal_Session {
  ...
  struct Chain {
    ...
    mutating func clearSenderRatchetKey() {_uniqueStorage()._senderRatchetKey = nil}
    ...
    mutating func clearSenderRatchetKeyPrivate() {_uniqueStorage()._senderRatchetKeyPrivate = nil}
    ...
    mutating func clearChainKey() {_uniqueStorage()._chainKey = nil}
...
struct Signal_Record {
  ...
  mutating func clearCurrentSession() {_uniqueStorage()._currentSession = nil}
...
struct Signal_SenderKeyState {
  ...
  mutating func clearSenderKeyID() {_uniqueStorage()._senderKeyID = nil}
  ...
  mutating func clearSenderChainKey() {_uniqueStorage()._senderChainKey = nil}
  ...
  mutating func clearSenderSigningKey() {_uniqueStorage()._senderSigningKey = nil}
  ...
  static func ==(lhs: Signal_Session.Chain, rhs: Signal_Session.Chain) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._senderRatchetKey != rhs_storage._senderRatchetKey {return false}
        if _storage._senderRatchetKeyPrivate != rhs_storage._senderRatchetKeyPrivate {return false}
        if _storage._chainKey != rhs_storage._chainKey {return false}
        if _storage._messageKeys != rhs_storage._messageKeys {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
  ...
  static func ==(lhs: Signal_Record, rhs: Signal_Record) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._previousSessions != rhs_storage._previousSessions {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
  ...
  static func ==(lhs: Signal_SenderKeyState, rhs: Signal_SenderKeyState) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._senderKeyID != rhs_storage._senderKeyID {return false}
        if _storage._senderChainKey != rhs_storage._senderChainKey {return false}
        if _storage._senderSigningKey != rhs_storage._senderSigningKey {return false}
        if _storage._senderMessageKeys != rhs_storage._senderMessageKeys {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
